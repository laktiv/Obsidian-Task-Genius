...
const translations = {
  "Comprehensive task management plugin for Obsidian with progress bars, task status cycling, and advanced task tracking features.": "Комплексний додаток для керування завданнями в Obsidian із прогрес-барами, циклічною зміною статусу завдань та розширеними функціями відстеження.",
  "Show progress bar": "Показувати індікатор прогресу",
  ...
  "Toggle this to allow adding progress bars to regular list items (non-task bullets).": "Увімкніть, щоб додати прогрес-бари до звичайних елементів списку (не завдань).",
  "Add progress bar to Heading": "Додавати прогрес-бар до заголовків",
  "Toggle this to allow this plugin to add progress bar for Task below the headings.": "Увімкніть, щоб додаток додавав прогрес-бари для завдань під заголовками.",
  ...
  "Specify tags that will hide progress bars (comma-separated, without #). Example: \"no-progress-bar,hide-progress\"": "Вкажіть мітки приховування прогрес-бару (через кому, без #). Наприклад: \"no-progress-bar,hide-progress\"",
  ...
  "You have unsaved changes. Save before closing?": "У вас є незбережені зміни. Зберегти перед закриттям?",
  "Rotate": "Повернути",
  ...
  "Standard project management workflow": "Стандартний процес управління проєктами",
  ...
  "Show progress bars based on heading": "Відображати прогрес-бар на основі заголовка",
  "Toggle this to enable showing progress bars based on heading.": "Увімкнути відображення прогрес-бару у заголовці.",
  "# heading": "# заголовок",
  ...
  "Enter the heading to ignore, e.g. '## Project', '## Inbox', separated by comma": "Enter the heading to ignore, e.g. '## Проєкт', '## Вхідні', розділені комами",
  "Focus all tasks behind heading": "Focus all tasks behind heading",
  "Enter the heading to focus, e.g. '## Project', '## Inbox', separated by comma": "Enter the heading to focus, e.g. '## Проєкт', '## Вхідні', розділені комами",
  "Level Name (e.g., common)": "Назва рівня (наприклад: звичайний)",
  "Delete Level": "Видалити рівень",
  "New Level": "Додати рівень",
  "Reward Name/Text": "Нагорода Назва/Текст",
  "New Reward": "Нова нагорода"
};
