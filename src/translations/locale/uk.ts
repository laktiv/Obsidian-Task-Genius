...
const translations = {
  ...
  "Комплексний додаток для керування завданнями в Obsidian з індікатором виконання, циклічною зміною станів, та розширеними функціями відстеження.",
  "Show progress bar": "Відображати індікатор прогресу",
